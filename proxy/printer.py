...
# Override print() to print to a file as well
import builtins
...
def pretty_print_payload(
    ...
    if id == 9:
        ...
        # Try to decode it as a plist
        try:
            print(plistlib.loads(_get_field(payload[1], 3)))
        except:
            # Try to decode it as json
            try:
                import json
                print(json.loads(_get_field(payload[1], 3)))
            except:
                # Print it raw
                try:
                    print(_get_field(payload[1], 3))
                except:
                    pass # No body at all?
